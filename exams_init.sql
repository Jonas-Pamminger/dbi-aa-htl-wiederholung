...
GRANT SELECT ON administrator.RoomType TO teacher_role;
GRANT SELECT ON administrator.Participant TO teacher_role;
GRANT SELECT ON administrator.Subject TO teacher_role;
GRANT SELECT ON administrator.Person TO teacher_role;
GRANT SELECT ON administrator.Class TO teacher_role;
...
-- Grant SELECT privilege on specific tables (administrator.Subject, administrator.Class, Test, administrator.Participant)
...
GRANT SELECT ON administrator.Room TO student_role;
GRANT SELECT ON administrator.RoomType TO student_role;
